...
key.setGlobalKey(["C-j", "l"], function (ev) {
    command.focusToById("urlbar");
}, 'Focus to the location bar', true);

key.setGlobalKey(["C-j", "g"], function (ev) {
    command.focusToById("searchbar");
}, 'Focus to the search bar', true);

key.setGlobalKey(["C-j", "t"], function (ev) {
    command.focusElement(command.elementsRetrieverTextarea, 0);
}, 'Focus to the first textarea', true);

key.setGlobalKey(["C-j", "s"], function (ev) {
...
key.setGlobalKey(["C-j", "C-f"], function (ev) {
    BrowserOpenFileWindow();
}, 'Open the local file', true);

key.setGlobalKey(["C-j", "C-s"], function (ev) {
...
key.setEditKey([["C-j", "u"], ["C-_"]], function (ev) {
...
key.setViewKey(["C-j", "h"], function (ev) {
...
key.setCaretKey(["C-j", "h"], function (ev) {
    goDoCommand("cmd_selectAll");
}, 'Select all', true);
